...
![A trusted architecture for FL support with graph-based analysis]([./proposed architecture.png](https://github.com/chendiqian/GNN4FL/blob/master/proposed%20architecture.png))
